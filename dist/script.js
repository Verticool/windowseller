...
var forms = function forms(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user-phone"]');
  var message = {
    loading: 'Загрузка...',
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    modal.addEventListener('click', function (e) {
      if (e.target === modal && closeClickOverlay) {
        ...
        modal.style.display = "none";
        document.body.style.overflow = "";
        document.body.style.marginRight = "".concat(0, "px"); // document.body.classList.remove('modal-open');
      }
    });
  }
...
var timer = function timer(id, deadline) {
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    function updateClock() {
      ...
      if (t.total <= 0) {
        days = (_readOnlyError("days"), "00");
        hours = (_readOnlyError("hours"), "00");
        minutes = (_readOnlyError("minutes"), "00");
        seconds = (_readOnlyError("seconds"), "00");
